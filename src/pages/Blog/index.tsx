    ...
    <div className="bg-black h-fit">
      ...
      <div className="pt-10 ">
        <Grid container className="pb-10">
          <Grid item xs={3}>
            <FaCss3Alt className="w-40 h-28 object-cover ml-8 rounded-md mb-3 relative text-white" />
          </Grid>
          <Grid item xs={9}>
          ...
          <Grid item xs={3}>
            <SiTypescript className="justify-center flex w-16 h-12 object-cover ml-12 mb-3 relative text-white" />
            <SiJavascript className="w-16 h-12 object-cover mb-3 text-white rounded-lg ml-24" />
          </Grid>
          <Grid item xs={9}>
            <div className="text-white flex flex-col justify-between pt-5 relative">
              <Link
          ...
          <Grid item xs={3}>
            <FiDatabase className="w-40 h-28 object-cover ml-8 rounded-md mb-3 relative text-white" />
          </Grid>
          <Grid item xs={9}>
            <div className="text-white flex flex-col justify-between pt-5 relative">
              <Link
